...
Use apenas dados ficticios nesta massa.

## Usuarios

| Perfil | Nome | CPF | E-mail |
|---|---|---|---|
| Admin | Admin Polo Rainbow | 111.111.111-11 | admin.hml@polorainbow.local |
| Atendimento | Atendimento HML | 222.222.222-22 | atendimento.hml@polorainbow.local |
| Financeiro | Financeiro HML | 333.333.333-33 | financeiro.hml@polorainbow.local |
| Professor PF | Prof. Ana Lima | 444.444.444-44 | ana.lima@polorainbow.local |
...
| Tipo | Nome | Status |
|---|---|---|
| Curso com promocao | Curso de Teste Promocional | Ativo |
| Curso sem promocao | Curso de Teste Padrao | Ativo |
| Turma 1 | Turma Presencial 01 | Aberta |
| Turma 2 | Turma Online Ao Vivo 01 | Aberta |

## Cupons

| Tipo | Codigo | Regras |
|---|---|---|
| Publico | BEMVINDO10 | 10% |
| Privado | VIP100 | 100% |
