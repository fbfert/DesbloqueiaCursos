...
return array(
    ...
    'from_email' => Env::get('MAIL_FROM_EMAIL', Env::get('SMTP_USERNAME', 'no-reply@localhost')),
    'from_name' => Env::get('MAIL_FROM_NAME', Env::get('APP_NAME', 'Polo Rainbow')),
    'reply_to' => Env::get('MAIL_REPLY_TO', Env::get('MAIL_FROM_EMAIL', Env::get('SMTP_USERNAME', 'no-reply@localhost'))),
