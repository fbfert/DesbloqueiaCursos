...
<!doctype html>
<html lang="pt-BR">
<head><meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1.0"><title>Pendência</title></head>
    ...
    <div style="max-width:640px;margin:0 auto;padding:24px;">
        <div style="background:#fff;border:1px solid #e5e7eb;border-radius:8px;padding:24px;">
            ...
            <?php if (!empty($observacao)): ?>
                <p>Observação: <?php echo Helpers::e($observacao); ?></p>
            <?php endif; ?>
