    ...
    <section class="status-card">
        <form method="post" action="<?php echo Helpers::e($action_url); ?>" class="admin-form" enctype="multipart/form-data">
            ...
            <section class="status-card" style="margin-top:16px;">
                ...
                <p class="muted">Cadastre quantas regras forem necessárias para incluir ou excluir o módulo por rota, page_key, área ou estado de autenticação.</p>
                <p class="muted">Exemplos: <code>/cursos/*</code>, <code>home</code>, <code>publica</code>, <code>guest</code>.</p>

                <div id="frontend-modulo-regras-lista">
                    <?php foreach ($regrasExibicao as $indice => $regra): ?>
...
<template id="frontend-modulo-regra-template">
    <div class="status-card" style="margin:12px 0;padding:12px;" data-regra-card="1">
        <div class="admin-form-grid">
            <label>
                Tipo
...
<script>
(function () {
    var lista = document.getElementById('frontend-modulo-regras-lista');
    var addBtn = document.getElementById('frontend-modulo-adicionar-regra');
    var template = document.getElementById('frontend-modulo-regra-template');
