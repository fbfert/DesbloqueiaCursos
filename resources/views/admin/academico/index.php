...
<form method="get" action="/admin/academico" class="form-grid">
    <label>Curso
...
<?php if (!empty($curso)): ?>
                ...
                <tbody>
                    <?php foreach ($avaliacoes as $avaliacao): ?>
                        <tr>
                            ...
                            <td><?php echo !empty($avaliacao['obrigatoria']) ? 'sim' : 'nao'; ?></td>
    ...
    <section class="panel">
        ...
        <form method="post" action="/admin/academico/nota" class="form-grid">
            <input type="hidden" name="curso_evento_id" value="<?php echo (int) $curso['id']; ?>">
            <input type="hidden" name="turma_id" value="<?php echo !empty($turma['id']) ? (int) $turma['id'] : ''; ?>">
            <label>Inscricao
                <select name="inscricao_id">
