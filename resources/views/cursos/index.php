...
<div class="front-section-stack">
    ...
    <section class="card-grid front-card-grid front-section">
        <?php if (empty($cursos)): ?>
            <article class="status-card front-card">
                <strong>Nenhum curso ativo</strong>
                <span>O catálogo ainda não possui itens públicos disponíveis.</span>
            </article>
        <?php else: ?>
            <?php foreach ($cursos as $curso): ?>
                <article class="course-card front-card">
