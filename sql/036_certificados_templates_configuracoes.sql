...
SELECT
    ...
    CONCAT(
        '<div style=\"text-align:center;margin:0 0 10px 0;\"><img src=\"{logo_url}\" alt=\"{instituicao_nome}\" width=\"180\" height=\"54\" style=\"width:180px;height:auto;border:none;display:block;margin:0 auto;\"></div>',
        '<h1 style=\"margin:0 0 10px 0;text-align:center;\">Certificado</h1>',
        '<p style=\"margin:0 0 8px 0;text-align:center;\">Certificamos que <strong>{aluno_nome}</strong> concluiu o curso <strong>{curso_nome}</strong>, com carga horária de {curso_carga_horaria}, realizado no período de {turma_data_inicio} a {turma_data_fim}.</p>',
        '<table style=\"width:100%;table-layout:fixed;margin-top:10px;\" cellpadding=\"0\" cellspacing=\"0\" border=\"0\">',
        '<tr>',
        '<td width=\"50%\" style=\"padding:0 4px 4px 0;font-size:9pt;\"><strong>Turma:</strong> {turma_nome}</td>',
        '<td width=\"50%\" style=\"padding:0 0 4px 4px;font-size:9pt;\"><strong>Local:</strong> {turma_local}</td>',
        '</tr>',
        '<tr>',
        '<td width=\"50%\" style=\"padding:0 4px 4px 0;font-size:9pt;\"><strong>Código de validação:</strong> {certificado_codigo}</td>',
        '<td width=\"50%\" style=\"padding:0 0 4px 4px;font-size:9pt;\"><strong>Valide em:</strong> {certificado_url_validacao}</td>',
        '</tr>',
        '<tr>',
        '<td width=\"50%\" style=\"padding:0 4px 4px 0;font-size:9pt;\"><strong>Data de emissão:</strong> {certificado_data_emissao}</td>',
        '<td width=\"50%\" style=\"padding:0 0 4px 4px;font-size:9pt;\"><strong>Emitido em:</strong> {cidade_data_atual}</td>',
        '</tr>',
        '</table>',
        '<table style=\"width:100%;table-layout:fixed;margin-top:14px;\" cellpadding=\"0\" cellspacing=\"0\" border=\"0\">',
        '<tr>',
        '<td width=\"33%\" align=\"center\" style=\"padding:0 6px;\">',
        '<div style=\"border-top:1px solid #000;padding-top:6px;\"><strong>{assinatura_1_nome}</strong><br>{assinatura_1_cargo}</div>',
        '</td>',
        '<td width=\"33%\" align=\"center\" style=\"padding:0 6px;\">',
        '<div style=\"border-top:1px solid #000;padding-top:6px;\"><strong>{assinatura_2_nome}</strong><br>{assinatura_2_cargo}</div>',
        '</td>',
        '<td width=\"34%\" align=\"center\" style=\"padding:0 6px;\">',
        '<div style=\"border-top:1px solid #000;padding-top:6px;\"><strong>{assinatura_3_nome}</strong><br>{assinatura_3_cargo}</div>',
        '</td>',
        '</tr>',
        '</table>',
        '<table style=\"width:100%;table-layout:fixed;margin-top:10px;\" cellpadding=\"0\" cellspacing=\"0\" border=\"0\">',
        '<tr>',
        '<td width=\"100%\" align=\"center\" style=\"padding:0;\"><img class=\"certificado-qrcode\" src=\"{certificado_qrcode}\" alt=\"QR Code do certificado\" width=\"70\" height=\"70\"></td>',
        '</tr>',
        '</table>'
    ),
    '#ffffff',
