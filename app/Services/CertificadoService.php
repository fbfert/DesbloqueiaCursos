...
class CertificadoService
{
    ...
    public function emitir($inscricaoId, array $opcoes = array(), $actorUserId = null, $ipAddress = null, $userAgent = null)
    {
        ...
        try {
            ...
            $this->certificadoModel->createHistory($certificadoId, $existente ? $existente['status'] : null, 'emitido', 'Emissão manual do certificado', $actorUserId);
    ...
    private function gerarPdf(array $certificado, array $template, array $assinantes, array $curso, array $turma, array $pedido)
    {
        ...
        $lines = array(
            ...
            'Validação publica: ' . Helpers::url('certificados/validar?codigo=' . urlencode($certificado['codigo'])),
        );
